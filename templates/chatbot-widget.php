...
<div id="met-chatbot-widget" class="met-chatbot-widget">
    ...
    <button id="met-chatbot-toggle" class="met-chatbot-toggle" aria-label="Abrir chat">
        <!-- Lucide Bus Icon -->
        <svg class="met-chatbot-icon" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            <path d="M4 6 2 7"/>
            <path d="M10 6h4"/>
            <path d="m22 7-2-1"/>
