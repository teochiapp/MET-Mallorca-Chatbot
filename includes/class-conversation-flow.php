...
class MET_Conversation_Flow
{
    ...
    private function step_route_type($message, $data)
    {
        ...
        if ($message === 'verify') {
            return array(
                'message' => '🔍 Por favor, escribe tu número de pedido (ej. 1234) y tu email separados por coma.<br><br>Ejemplo: 1234, email@ejemplo.com',
    ...
    private function step_verify_booking_code($message, $data)
    {
        ...
        if (count($parts) < 2) {
            return array(
                'message' => '❌ Por favor, proporciona el número de pedido y email separados por coma.<br><br>Ejemplo: 1234, email@ejemplo.com',
                'nextStep' => 'verify_booking_code',
                'options' => array(),
                'data' => $data,
                'inputType' => 'text'
    ...
    private function get_chauffeur_locations()
    {
        ...
        foreach ($locations as $location_id => $location_data) {
            ...
            if (
                strpos($name_lower, 'airport') !== false ||
    ...
    private function get_destination_options($origin)
    {
        ...
        if (
            strpos(strtolower($origin), 'airport') !== false ||
